...
### CCA ###
import transformers
from llava.mca_utils.mca_chair import mca_forward, llamaforcausallm_forward
...
def eval_model(args):
    ...
    for idx, line in enumerate(tqdm(questions)):
        ...
        image_file = "COCO_val2014_{:0>{}}.jpg".format(img_id, 12)

        qs = "Please describe this image in detail. ASSISTANT:"
        cur_prompt = qs
