...
### MCA ###
import transformers
from llava.mca_utils.mca import mca_forward, llamaforcausallm_forward
...
def eval_model(args):
    ...
    for idx, line in enumerate(tqdm(questions)):
        ...
        output_text.append({"id": question_id,
                                   "prompt": cur_prompt,
                                   "response": outputs})
    json.dump(output_text, ans_file, indent=4)
